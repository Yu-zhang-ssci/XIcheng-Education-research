...
with open('village_2021_with_roomnum_school_gcj02ll_wgs84.json','r') as f:
...
for village in newvillages:
  ...
  #village['common transportation']=[]
  #village['neighbor school common transportation']=[]
  #village['neighbor school taxi']=[]
  #village['taxi']=[]
  #village['now school taxi']=[]
  #village['now school common transportation']=[]
